...
// asset-input/node_modules/semver/semver.js
var require_semver = __commonJS({
  "asset-input/node_modules/semver/semver.js"(exports2, module2) {
...
// asset-input/node_modules/uuid/lib/rng.js
var require_rng = __commonJS({
  "asset-input/node_modules/uuid/lib/rng.js"(exports2, module2) {
    var crypto = require("crypto");
...
// asset-input/node_modules/uuid/lib/bytesToUuid.js
var require_bytesToUuid = __commonJS({
  "asset-input/node_modules/uuid/lib/bytesToUuid.js"(exports2, module2) {
    var byteToHex = [];
    for (i = 0; i < 256; ++i) {
...
// asset-input/node_modules/uuid/v1.js
var require_v1 = __commonJS({
  "asset-input/node_modules/uuid/v1.js"(exports2, module2) {
    var rng = require_rng();
...
// asset-input/node_modules/uuid/v4.js
var require_v4 = __commonJS({
  "asset-input/node_modules/uuid/v4.js"(exports2, module2) {
    var rng = require_rng();
    var bytesToUuid = require_bytesToUuid();
...
// asset-input/node_modules/uuid/index.js
var require_uuid = __commonJS({
  "asset-input/node_modules/uuid/index.js"(exports2, module2) {
    var v1 = require_v1();
    var v4 = require_v4();
    var uuid2 = v4;
    uuid2.v1 = v1;
...
// asset-input/lambda/products/ordersFunction.js
var AWS = require("aws-sdk");
var AWSXRay = require_lib();
var uuid = require_uuid();
var xRay = AWSXRay.captureAWS(require("aws-sdk"));
var productsDdb = process.env.PRODUCTS_DDB;
var ordersDdb = process.env.ORDERS_DDB;
var awsRegion = process.env.AWS_REGION;
var orderEventsTopicArn = process.env.ORDER_EVENTS_TOPIC_ARN;
AWS.config.update({
  region: awsRegion
});
...
exports.handler = async function(event, context) {
  ...
  if (event.resource === "/orders") {
    if (method === "GET") {
      ...
      if (data.Item) {
        const eventResult = await sendOrderEvent(data.Item, "ORDER_DELETED", lambdaRequestId);
        console.log(`Order created event sent -Order: ${data.Item.sk} - MessageId: ${eventResult.MessageId}`);
        return {
          statusCode: 200,
          body: JSON.stringify(convertToOrderResponse(data.Item))
        };
